  ...
  return (
    <main>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p>
          Three subscription tiers are available to meet your needs, ensuring
          you can easily be on the road to achieving your goals.
        </p>
        <p>
          Recordings can be revised every 30 or 90 days depending on the
          subscription chosen, so new recordings can be scheduled as your goals
          change.
        </p>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2>Step By Step - Here&apos;s How to Get Started</h2>
        <ul>
          <li>
            To get the best results, listen to each audio 21 times. This is what
            the Reach For The Stars algorithm automatically does for you.
          </li>
          <li>
            Before you sign in and turn on the program, make sure you are in a
            comfortable place to relax and where you are unlikely to be
            disturbed.
          </li>
          <li>
            To listen, use your device&apos;s internet browser and go to the
            website ReachForTheStars.Today. Then log in by clicking on the
            "LOGIN" button in the upper right corner. Once logged in, simply
            click the Play Icon or "Start Playing" button at the top of the
            page.
          </li>
          <li>
            If already logged in, just navigate to the Meditation Session page
            by clicking on the "Play Options" button in the upper portion of
            the window before hitting the Play Icon or "Start Playing" button.
          </li>
          <li>
            For optimal autoplay functionality on mobile devices, your lock
            screen/screensaver has automatically been disabled for you. If you
            plan on manually locking your device during the playback period (up
            to 5 hours after you start the program), please verify that any
            ReachForTheStars audio continues playing after your device has been
            locked.
          </li>
          <li>
            If the audio stops and/or media player controls don&apos;t appear on
            your device&apos;s lock screen, you may need to allow notifications
            from the browser you are using. Alternatively, you can set the
            Meditation Session to play only one recording at a time. Then, if
            you happen to wake up later that night, you can start the second
            recording by simply unlocking your phone and clicking on the Play
            Icon or "Start Playing" button.
          </li>
          <li>
            You will first hear a short piece of relaxing music that will allow
            you the time to get into a comfortable position. The Meditation
            Session will play two recordings during each session, two-and-a-half
            hours apart, and the sessions will rotate through the selected goals
            you have chosen. Each one will eventually play 21 times for maximum
            effect. Please remember, these recordings will not only help you
            fall asleep, but provide their full benefits whether you are asleep
            or not.
          </li>
          <li>
            There is an option to listen to only one meditation recording per
            night. This will double the amount of time it takes to complete your
            programmed sessions unless you manually start the second audio later
            that night. See the FAQ section for why you might want to do this.
          </li>
        </ul>
      </section>
